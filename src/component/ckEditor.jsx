 ...
 * https://ckeditor.com/ckeditor-5/builder/#installation/NodgNARATAdCMFYKQIwAYAsCDMGAc6a2aRC6eCAbCiHgJwghR0bbEOWYp2VVrIQApgDtkaMMBRhxUqTIC6kAMaC6gkACNBEeUA==
 */
	...
	const { editorConfig } = useMemo(() => {
		...
		return {
			editorConfig: {
				...
				blockToolbar: ['bold', 'italic', '|', 'link', 'insertTable', 'insertTableLayout'],
				image: {
					toolbar: []
				},
				initialData:
